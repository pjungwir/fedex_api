require 'fedex_api/credentials'
require 'fedex_api/request/label'
require 'fedex_api/request/rate'
require 'fedex_api/request/tracking_information'
require 'fedex_api/request/address'
require 'fedex_api/request/document'
require 'fedex_api/request/delete'
require 'fedex_api/request/ground_close'
require 'fedex_api/request/pickup'
require 'fedex_api/request/pickup_availability'
require 'fedex_api/request/service_availability'
...
module FedexApi
  class Shipment
    ...
    #
    # return a FedexApi::Shipment object
    ...
    # @param [String] service_type, A valid fedex service type, to view a complete list of services FedexApi::Shipment::SERVICE_TYPES
    ...
    # @param [String] carrier_code, A valid fedex carrier code, to view a complete list of carrier codes FedexApi::Shipment::CARRIER_CODES
    ...
    # @param [Hash] package_type, A string identifitying the type of tracking number used. Full list FedexApi::Track::PACKAGE_IDENTIFIER_TYPES
    def track(options = {})
