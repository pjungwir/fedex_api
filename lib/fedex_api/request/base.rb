require 'httparty'
require 'nokogiri'
require 'fedex_api/helpers'
require 'fedex_api/rate'
...
module FedexApi
  module Request
    class Base
      ...
      #
      # return a FedexApi::Request::Base object
      ...
      def add_shipper(xml)
        xml.Shipper{
          xml.Contact{
            ...
            xml.PhoneExtension @shipper[:phone_extension]
          }
          xml.Address {
      ...
      def add_recipient(xml)
        xml.Recipient{
          xml.Contact{
            ...
            xml.PhoneExtension @recipient[:phone_extension]
          }
          xml.Address {
      ...
      def add_shipping_charges_payment(xml)
        xml.ShippingChargesPayment{
          ...
          xml.Payor{
            if service[:version].to_i >= FedexApi::API_VERSION.to_i
