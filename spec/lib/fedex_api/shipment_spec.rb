require 'spec_helper'
require 'fedex_api/shipment'

describe FedexApi::Request::Shipment do
  describe "ship service" do
    let(:fedex) { FedexApi::Shipment.new(fedex_credentials) }
    let(:shipper) do
    ...
    context "domestic shipment", :vcr do
      ...
      it "succeeds" do
        ...
        expect(@shipment.class).not_to eq(FedexApi::RateError)
      end
